---
title: Software tools for Maximum Likelihood Estimation:MB
title-slide-attributes:
    data-background-image: "https://qfcatmsu.github.io/Images/dark-big.png"  
    data-background-size: "40%"
    data-background-position: "6% 95%"
subtitle: Lesson 2 - first RTMB & Derivatives <br> [Click here to view presentation online](https://qfcatmsu.github.io/MLE-Software/lesson2/MLE_lec2.html){style="position:absolute;top:40%lesson1;left:35%;font-size:20px;"}
author: Jim Bence
...
-   All that derivative stuff
    -   Definitions derivatives, partial derivatives, second derivatives, cross
        derivatives (aka mixed second derivatives), gradient vector and Hessian
-   Methods to calculate/appoximate derivatives
-   Exercise: finite difference derivatives
-   Using the Hessian and gradient vector in parameter searches and to assess
    uncertainty
...
-   Exercise - change model to assume gamma rather than normal (in breakout
    groups)
